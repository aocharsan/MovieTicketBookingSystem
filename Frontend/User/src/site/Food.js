...
addBooking(){
 if(this.state.user_id===null || this.state.user_id==="")
 {
    ...
    localStorage.setItem("totalamt",this.state.totalamt);

    localStorage.setItem("fooditmes",JSON.stringify(this.state.food));
		  ...
		  <div class="container py-lg-4">
			...
			<div class="contact-view mt-lg-5 mt-4">
			  <div class="conhny-form-section">
                ...
                <br></br>
				  <button onClick={this.addBooking}>Book Now</button>
			  </div>
